...
export const defaultHeroSlides: HeroSlide[] = [
  ...
  },
  {
    ...
    description: "Major corporations committed $9T to U.S. manufacturing. Discover how minority-owned businesses can capture unprecedented federal contracting opportunities.",
    ctaText: "Learn More",
    ctaLink: "/news/9-trillion-american-manufacturing-boom-minority-owned-businesses",
