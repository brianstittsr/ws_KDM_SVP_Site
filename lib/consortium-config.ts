...
export const defaultHeroSlides: HeroSlide[] = [
  {
    ...
    backgroundColor: "bg-gradient-to-br from-[#1e3a5f]/90 via-[#2d4a6f]/85 to-[#1e3a5f]/90",
    textColor: "light",
    order: 1,
    isActive: true,
  },
  ...
  },
  {
    ...
    backgroundColor: "bg-gradient-to-br from-[#0f766e]/90 via-[#14b8a6]/85 to-[#0f766e]/90",
    textColor: "light",
    order: 3,
    isActive: true,
  },
  {
    ...
    backgroundColor: "bg-gradient-to-br from-[#7c3aed]/90 via-[#8b5cf6]/85 to-[#7c3aed]/90",
    textColor: "light",
    order: 4,
    isActive: true,
  },
  {
    ...
    backgroundColor: "bg-gradient-to-br from-[#c9a227]/90 via-[#d4af37]/85 to-[#c9a227]/90",
    textColor: "light",
    order: 5,
    isActive: true,
  },
