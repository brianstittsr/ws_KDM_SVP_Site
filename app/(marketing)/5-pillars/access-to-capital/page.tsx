                ...
                <div className="flex items-start gap-4">
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-muted-foreground mb-3">
                      Puerto Rico's agricultural sector is undergoing a pivotal transformation, driven by public policy priorities, private sector incentives, and grassroots innovation.
                    </div>
                    <div className="flex gap-2 flex-wrap">
                      <span className="text-xs bg-orange-100 text-orange-800 px-2 py-1 rounded">Economic Development</span>
                      <span className="text-xs bg-orange-100 text-orange-800 px-2 py-1 rounded">Innovation</span>
                      <span className="text-xs bg-orange-100 text-orange-800 px-2 py-1 rounded">Agriculture</span>
                    </div>
                  </div>
