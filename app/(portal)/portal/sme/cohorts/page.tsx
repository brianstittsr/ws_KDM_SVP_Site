...
export default function MyCohortsPage() {
  ...
  const loadData = async () => {
    ...
    try {
      const q = query(collection(db, "cohortEnrollments"));
    ...
    <div className="container mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Manage your my cohorts</p>
        </div>
        <Button>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>View and manage your my cohorts</CardDescription>
        </CardHeader>
        <CardContent>
          {items.length === 0 ? (
