...
export default function CreateCohortPage() {
  ...
  const loadData = async () => {
    ...
    try {
      const q = query(collection(db, "cmmcCohorts"));
    ...
    <div className="container mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Manage your create cohort</p>
        </div>
        <Button>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>View and manage your create cohort</CardDescription>
        </CardHeader>
        <CardContent>
          {items.length === 0 ? (
