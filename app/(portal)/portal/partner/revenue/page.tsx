...
export default function RevenueDashboardPage() {
  ...
  const loadData = async () => {
    ...
    try {
      const q = query(collection(db, "partnerRevenue"));
    ...
    <div className="container mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Manage your revenue dashboard</p>
        </div>
        <Button>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>View and manage your revenue dashboard</CardDescription>
        </CardHeader>
        <CardContent>
          {items.length === 0 ? (
