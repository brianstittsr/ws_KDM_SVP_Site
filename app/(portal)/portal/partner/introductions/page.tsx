...
export default function IntroductionsPage() {
  ...
  useEffect(() => {
    if (useMockData) {
      setItems(mockIntroductions as any[]);
      setLoading(false);
    } else {
      loadData();
    }
  ...
  const loadData = async () => {
    ...
    try {
      const q = query(collection(db, "partnerIntroductions"));
    ...
    <div className="container mx-auto p-6">
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-muted-foreground">Manage your introductions</p>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>View and manage your introductions</CardDescription>
        </CardHeader>
        <CardContent>
          {items.length === 0 ? (
