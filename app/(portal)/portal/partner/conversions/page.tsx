...
export default function ConversionTrackingPage() {
  ...
  const loadData = async () => {
    ...
    try {
      const q = query(collection(db, "conversionTracking"));
    ...
    <div className="container mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Manage your conversion tracking</p>
        </div>
        <Button>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>View and manage your conversion tracking</CardDescription>
        </CardHeader>
        <CardContent>
          {items.length === 0 ? (
