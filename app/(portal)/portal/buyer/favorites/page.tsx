...
import { mockSavedSMEs } from "@/lib/mock-data/buyer-mock-data";
...
export default function SavedSMEsPage() {
  ...
  const loadData = async () => {
    ...
    try {
      const q = query(collection(db, "buyerFavorites"));
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Saved SMEs</CardTitle>
          <CardDescription>View and manage your saved smes</CardDescription>
        </CardHeader>
        <CardContent>
          {items.length === 0 ? (
